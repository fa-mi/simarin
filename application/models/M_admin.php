...
class M_admin extends CI_Model
{
  ...
  public function data_dashboard_admin(){
    ...
    $query4 = $this->db->query("SELECT COUNT(siswa.nis) AS jumlah_siswa_prakerin FROM siswa INNER JOIN prakerin on prakerin.nis = siswa.nis where prakerin.is_aktif = 1");
