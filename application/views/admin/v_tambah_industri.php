          ...
          <div class="x_content">
            <form class="form-horizontal form-label-left" action="<?php echo base_url('c_admin/tambah_industri'); ?>" method="post">
              <div class="form-group">
                ...
                <div class="item form-group">
                  <label class="control-label col-md-3 col-sm-3 col-xs-12" for="industri">Alamat Industri
                  </label>
                  <div class="col-md-6 col-sm-6 col-xs-12">
                    <input type="text" name="alamat" class="optional form-control col-md-7 col-xs-12" required
                    oninvalid="this.setCustomValidity('Data Tidak Boleh Kosong !')" oninput="setCustomValidity('')">
                  </div>
                </div>
                <div class="item form-group">
                  <label class="control-label col-md-3 col-sm-3 col-xs-12" for="nis">No. Telp
                  </label>
                  <div class="col-md-6 col-sm-6 col-xs-12">
                    <input type="text" class="optional form-control col-md-7 col-xs-12" name="telp" id="nis">
                  </div>
                </div>
                ...
                echo "<div class='col-md-3 col-md-offset-3 alert alert-warning'>No Telp Sudah Ada!</div>";
